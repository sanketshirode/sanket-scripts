...
#>
param(
   [string]$MsiUrl = "https://downloads.puppetlabs.com/windows/puppet/puppet-agent-6.0.0-x64.msi"
  ,[string]$PuppetVersion = $null
)

if ($PuppetVersion -ne $null) {
  $MsiUrl = "https://downloads.puppetlabs.com/windows/puppet/puppet-agent-$($PuppetVersion)-x64.msi"
